        ...
        <div className="max-w-4xl mx-auto py-8 px-4">
          <div className="flex items-center justify-between mb-8">
            <div className="flex items-center space-x-2">
              ...
              <h1 className="text-2xl font-bold text-gray-900 dark:text-white">DPIN</h1>
            </div>
            <div className="flex items-center space-x-4">
              <button
                onClick={() => setIsModelOpen(true)}
                className="flex cursor-pointer items-center space-x-2 px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors duration-200"
              >
